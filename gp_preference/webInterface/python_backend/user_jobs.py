...
class TheoreticalUser(UserPreference):
    ...
    def utility(self, job_matrix, add_noise=False):
    ...
    def initialise_utility_functions():
        return {
            ...
            specs_jobs.obj_fte: utility_func_jobs.utility_fte,
            specs_jobs.obj_prob: utility_func_jobs.utility_probation_time,
            specs_jobs.obj_budget: utility_func_jobs.utility_personal_development_budget
        }

...
function handleSurveySubmit() {
    ...
    var question_names = ['pairwise-effort', 'ranking-effort', 'understand-pairwise', 'understand-ranking'];
    ...
    // (outcome ranking)
    var outcome_ranking = []
    var cluster_names = ['top-cluster', 'good-cluster']
    for (var j=0; j<2; j++) {
        console.log(document.getElementById(cluster_names[j]));
    ...
    var cluster_names = ['prefer-best', 'prefer-medium']
    for (var j=0; j<2; j++) {

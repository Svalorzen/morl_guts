...
class DiscreteAcquirer:
    def __init__(self, input_domain, query_type, seed, acquisition_type='expected improvement'):
        ...
        :param input_domain:    The datapoints on which the discrete acquirer is defined.
        :param query_type:      The query type of the current experiment (pairwise/ranking/clustering/top_rank)
        """
